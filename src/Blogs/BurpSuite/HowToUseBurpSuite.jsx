const HowToUseBurpSuite = () => {
  return (
    <div className="prose  p-4 w-9/12">
      <h1 className="text-3xl text-justify font-bold mb-4">How to Use Burp Suite</h1>
      ...
      <h2 className="text-2xl font-semibold my-2">Using the Proxy Tool</h2>
      <h3 className="text-xl font-semibold mb-2">
      ...
      <h2 className="text-2xl font-semibold my-2">Spidering with Burp Suite</h2>
      <h3 className="text-xl font-semibold mb-2">Setting up the Spider Tool</h3>
      <p className="text-justify">
      ...
      <p className="text-justify">The Scanner tool automates the process of finding vulnerabilities.</p>
      <ol className="list-decimal ml-6">
      ...
      <h2 className="text-2xl font-semibold my-2">Intruder Tool</h2>
      <h3 className="text-xl font-semibold mb-2">
      ...
      <h2 className="text-2xl font-semibold my-2">Repeater Tool</h2>
      <h3 className="text-xl font-semibold mb-2">
        Sending Requests Repeatedly
      </h3>
      <p className="text-justify">The Repeater tool allows for manual testing of individual requests.</p>
      <ol className="list-decimal ml-6">
        <li>Send a request from the Proxy to the Repeater.</li>
        <li>Modify the request parameters and resend it multiple times.</li>
      </ol>

      <h3 className="text-xl font-semibold mb-2">Analyzing Responses</h3>
      <p className="text-justify">
        Review the responses to understand how the application handles different
        inputs.
      </p>

      <h2 className="text-2xl font-semibold my-2">SequencerTool</h2>
      <h3 className="text-xl font-semibold mb-2">Analyzing Session Tokens</h3>
      <p className="text-justify">
      ...
      <h2 className="text-2xl font-semibold my-2">Decoder Tool</h2>
      <h3 className="text-xl font-semibold mb-2">Encoding and Decoding Data</h3>
      <p className="text-justify">The Decoder tool helps you encode and decode various data formats.</p>
      <ol className="list-decimal ml-6">
      ...
      <h2 className="text-2xl font-semibold my-2">Comparer Tool</h2>
      <h3 className="text-xl font-semibold mb-2">
      ...
      <h3 className="text-xl font-semibold mb-2">Identifying Differences</h3>
      <p className="text-justify">
        Review the differences to understand changes in responses based on
        different inputs.
      </p>

      <h2 className="text-2xl font-semibold my-2">Extending Burp Suite</h2>
      <h3 className="text-xl font-semibold mb-2">
      ...
      <h3 className="text-xl font-semibold mb-2">Ethical Hacking Guidelines</h3>
      <p className="text-justify">
      ...
      <h2 className="text-2xl font-semibold my-2">Conclusion</h2>
      <p className="text-justify">
      ...
      <h2 className="text-2xl font-semibold my-2">FAQs</h2>
      <h3 className="text-xl font-semibold mb-2">What is Burp Suite?</h3>
      <p className="text-justify">
